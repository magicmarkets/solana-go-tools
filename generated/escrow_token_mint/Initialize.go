...
func (inst *Initialize) SetFaucetAccount(faucet ag_solanago.PublicKey) *Initialize {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(faucet).WRITE()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("Initialize")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=6]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("    tokenMint", inst.AccountMetaSlice.Get(1)))
						accountsBranch.Child(ag_format.Meta("       faucet", inst.AccountMetaSlice.Get(2)))
